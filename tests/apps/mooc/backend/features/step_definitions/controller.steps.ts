...
Given('I send POST request to {string}', function (string, docString) {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('the response status code shold be {int}', function (int) {
  // Then('the response status code shold be {float}', function (float) {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
